...
" Core
let mapleader=","
nmap <leader>a :NvimTreeFindFileToggle<CR>
nmap \ <leader>a
...
nmap <leader>t <C-w>s<C-w>j:terminal<CR>:set nonumber<CR><S-a>
nmap <leader>T <C-w>v<C-w>l:terminal<CR>:set nonumber<CR><S-a>
